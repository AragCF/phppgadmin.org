 ...
 */
 ...
 function __construct($element = null) {
  $this->__XHtmlSimpleElement($element);
 }
 
 function __XHtmlSimpleElement($element = null) {
...
class XHtmlElement extends XHtmlSimpleElement {
 ...
 function __construct($text = null) {
  $this->__XHtmlElement($text);
 }
 function __XHtmlElement($text = null) {
  XHtmlSimpleElement::__XHtmlSimpleElement();
...
class XHTML_Button extends XHtmlElement {
 function __construct ($name, $text = null) {
  $this->__XHTML_Button($name, $text);
 }
 function __XHTML_Button ($name, $text = null) {
  parent::__XHtmlElement();
...
class XHTML_Option extends XHtmlElement {
 function __construct ($text, $value = null) {
  $this->__XHTML_Option($text, $value);
 }
 function __XHTML_Option($text, $value = null) {
  XHtmlElement::__XHtmlElement(null);   
  $this->set_text($text);
 }
}
...
class XHTML_Select extends XHTMLElement {
 ...
 function __construct ($name, $multiple = false, $size = null) {
  $this->__XHTML_Select($name, $multiple, $size);
 }
 function __XHTML_Select ($name, $multiple = false, $size = null) {
  XHtmlElement::__XHtmlElement();     
